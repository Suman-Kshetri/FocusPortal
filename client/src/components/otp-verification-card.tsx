...
const createOtpSchema = (length: number) =>
  z
    .string()
...
export const OtpVerificationCard = ({
  ...
  return (
    <div className="mb-6">
      ...
      <div className="flex justify-center gap-2 sm:gap-3">
        {otp.map((digit, index) => (
          <input
            ...
            className={`w-12 h-12 sm:w-14 sm:h-14 text-center text-xl sm:text-2xl font-semibold border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-ring focus:border-ring transition-all ${
              error
      ...
      {error && (
        <p className="text-destructive text-sm text-center mt-3 flex items-center justify-center gap-1">
